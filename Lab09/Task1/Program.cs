...
namespace Task1
{
    class Program
    {
        ...
        {
            string pathToTickerFile = "D:\\Study\\2 Course\\3 semestr\\C# 2023\\Code\\Lab09\\Task1\\ticker.txt";
                ...
                try
                {
                    ...
                    lock (locker)
                    {
                        using (StreamWriter streamWriter =
                               new StreamWriter("D:\\Study\\2 Course\\3 semestr\\C# 2023\\Code\\Lab09\\Task1\\output.txt", true))
                        {
